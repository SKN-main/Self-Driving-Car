    ...
    def __call__(self, frame):
        ...
        if self.turn.value == Direction.STRAIGHT.value:
            if left_tracker_direction.value == Direction.STRAIGHT.value:
                ...
                turn_value = abs(self.left_tracker.deviation)//2
            else:
                self.direction = right_tracker_direction
                turn_value = abs(self.right_tracker.deviation)//2
        else:
            turn_value = 100
        ...
        return mask, self.direction, int(turn_value)
...
def show_video():
    ...
    while not is_finish:
        ...
        while success and not is_finish:
            ...
            mask, direction, turn_value = car(image)
        ...
        # time.sleep(0.1) 
            ...
            #     action = 'r'
            # if action in "wasdr":
            #     return_value = write_read(action)
            #     time.sleep(0.05)
            #     print(action)
            #     print(return_value)
